...
namespace RockMargin
{
    ...
    // Below order adjusted to match displayed order in VS options screen
    // Note: Colors are in ARGB order. Ex: 0xff010203 means A=255, R=1, G=2, B=3  (display in options screen is "R, G, B" when A=ff. If A!=ff, display is "A, R, G, B")
    ...
    {
        public override uint Default { get { return 110; } } // original: 75
    ...
    {
        public override uint Default { get { return 0xff1e1e1e; } } // original: 0xffffffff
    ...
    {
        public override uint Default { get { return 0xff006e00; } } // original: 0xff00a000
        public override EditorOptionKey<uint> Key { get { return OptionsKeys.CommentsColor; } }
    }

    [Export(typeof(EditorOptionDefinition))]
    public sealed class MarginColorOption : ViewOptionDefinition<uint> // "Scroll margin"
    {
        public override uint Default { get { return 0xff1e1e1e; } } // original: 0xfff0f0f0
    ...
    {
        public override uint Default { get { return 0x784664ff; } } // original: 0x400000ff
    ...
    [Export(typeof(EditorOptionDefinition))]
    public sealed class HighlightColorOption : ViewOptionDefinition<uint> // "Text markers"
    {
    ...
    // --- Text markers
    [Export(typeof(EditorOptionDefinition))]
    public sealed class AltHighlightsOption : ViewOptionDefinition<bool> // "Alt + Double click"
    {
    ...
    {
        public override uint Default { get { return 0xff00468c; } } // original: 0xffadd8e6
